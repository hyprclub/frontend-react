...
const items = [
	...
	},
	{
		title: 'Hosting',
		icon: 'lightning',
		items: ['How does it work', 'How to start with Stacks', 'Dose it suppport Dark Mode', 'What is Stacks Design System'],
	},
	{
		title: 'Product',
		icon: 'pen',
		...
		<div className={''}>
			<div className={cn('container', styles.container)}>
				<div className={styles.top}>
					...
					<Dropdown className={cn('mobile-show', styles.dropdown)} value={direction} setValue={setDirection} options={options} />
				</div>
